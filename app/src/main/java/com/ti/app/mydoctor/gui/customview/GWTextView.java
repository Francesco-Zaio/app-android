...
public class GWTextView extends AppCompatTextView {
	...
	private final static int ROBOTO_THIN = 3;
	 ...
	 */
	public GWTextView(Context context) {
		super(context);		
	}
	 ...
	 * @see #MyDoctorAtHomeTextView(Context, AttributeSet, int)
	 */
	public GWTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @see #MyDoctorAtHomeTextView(Context, AttributeSet)
	 */
	public GWTextView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void parseAttributes(Context context, AttributeSet attrs) {
		...
		TypedArray values = context.obtainStyledAttributes(attrs, R.styleable.GWTextView);

	    int typefaceValue = values.getInt(R.styleable.GWTextView_typeface, 0);
	    values.recycle();
