		...
		public void onClick(View v) {
			...
			case R.id.confirm_button:
				...
				try {
					...
					sc.setTargetCfg(dbManager.getDefaultServerConf().getTargetCfgDef());
					sc.setTargetSend(dbManager.getDefaultServerConf().getTargetSendDef());
					sc.setProtocol(dbManager.getDefaultServerConf().getProtocolDef());
