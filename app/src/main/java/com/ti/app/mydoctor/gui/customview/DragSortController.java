...
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    private static Direction mDirectionRemove;
    private static Direction mDirectionBlockRemove;
    ...
    public boolean onTouch(View v, MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
            	if(mPositionX>=0){
            		setDirectionRemove(Direction.RIGHT);
            	} else {
            		setDirectionRemove(Direction.LEFT);
            	}
    ...
    /**
     * Get the position to startOperation dragging based on the ACTION_DOWN
    ...
    static public Direction getDirectionRemove() {
		return mDirectionRemove;
	}

	static public void setDirectionRemove(Direction direction) {
		DragSortController.mDirectionRemove = direction;
	}

	public static Direction getDirectionBlockRemove() {
		return mDirectionBlockRemove;
	}

	public static void setDirectionBlockRemove(Direction directionBlockRemove) {
		DragSortController.mDirectionBlockRemove = directionBlockRemove;
	}
